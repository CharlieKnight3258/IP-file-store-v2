...
async def refresh_cb(c, m):
    ...
    if UPDATE_CHANNEL:
        ...
        try:
            ...
            await m.answer('You are not yet joined our channel. First join and then press refresh button �中', show_alert=True)
    ...
    if msg.empty:
        ...
        return await m.reply_text(f"�打 Sorry bro your file was missing\n\nPlease contact my owner �� {owner.mention(style='md')}")
